...
const locationMiddleware = __importStar(require("../middlewares/location.middleware"));
router.get('/getAllLocations', locationController.getAllLocations);
router.post('/createLocation', locationMiddleware.checkLocationIsExist, locationController.createLocation);
router.put('/updateLocation', locationMiddleware.checkUpdatingLocation, locationController.updateLocation);
